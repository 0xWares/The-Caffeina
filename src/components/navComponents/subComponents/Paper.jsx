...
const Paper = ({ title, author, readTime, year}) => {
    ...
    return (
      <div className="flex flex-col border-b  border-[#22191C] cursor-pointer transition-transform duration-300 hover:scale-101 sm:flex-row px-5 py-4 sm:px-8 sm:py-5 md:px-10 md:py-5 gap-4 sm:gap-3 border  bg-[#171516] rounded-2xl mb-2">
