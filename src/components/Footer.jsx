  ...
  return (
    <div className="w-full bg-[#141414] flex flex-col gap-4 sm:gap-6 py-6 sm:py-8 px-4">
      <div className="flex flex-row gap-4 sm:gap-6 md:gap-8 justify-center items-center flex-wrap text-center">
        <p className="text-[#8A8683] text-xs sm:text-sm cursor-pointer hover:text-white transition-colors">
          RESEARCH PAPERS
        </p>
        <p className="text-[#8A8683] text-xs sm:text-sm cursor-pointer hover:text-white transition-colors">
          FIELD STORIES
      ...
      <div className="flex flex-row gap-x-2 gap-y-1 justify-center items-center flex-wrap text-center">
        <p className="text-[#8A8683] text-xs sm:text-sm font-bold">The Caffeina</p>
        <span className="text-[#8A8683] text-xs sm:text-sm">•</span>
        <p className="text-[#8A8683] text-xs sm:text-sm">Dhaka</p>
        <span className="text-[#8A8683] text-xs sm:text-sm">•</span>
        <p className="text-[#8A8683] text-xs sm:text-sm">Bangladesh</p>
        <span className="text-[#8A8683] text-xs sm:text-sm">•</span>
        <p className="text-[#8A8683] text-xs sm:text-sm">&copy; 2026</p>
      </div>
